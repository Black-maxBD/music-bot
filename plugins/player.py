...
async def notforu(_, m: Message):
    k = await _.send_cached_media(chat_id=m.chat.id, file_id="CAADBQADEgQAAtMJyFVJOe6-VqYVzAI", caption="You Are Not Authorized", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('⚡️Join Here', url='https://t.me/bdbots')]]))
    await delete_messages([m, k])
...
async def not_chat(_, m: Message):
    if m.from_user is not None and m.from_user.id in Config.SUDO:
        ...
        buttons = [
            [
                InlineKeyboardButton('⚡️ Group ', url='https://t.me/+Dw37PB5UzAE4MGFl'),
                InlineKeyboardButton('🧩 Join Here', url='https://t.me/Mirrorcloudbd'),
            ]
            ]
        await m.reply("<b>You have to join @mirrorcloudbd for using me 🙂 [Link]( https://t.me/+Dw37PB5UzAE4MGFl ) below.</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
